...
var userInput = document.querySelector('.input'); // setup for user input
var display = document.querySelector('#cities');
var savedCities = [];
var btn = document.querySelector('.button');
var clear = document.querySelector('#clear');
//just added to mess around
...
//Added from activity 3 to write to table element

// 5 day forcast call=> api.openweathermap.org/data/2.5/forecast?lat={lat}&lon={lon}&appid={API key}
// https://openweathermap.org/forecast5 docs
//Geo coding API = 'http://api.openweathermap.org/geo/1.0/direct?q={city name},{state code},{country code}&limit={limit}&appid={API key}'

//This is the icon url'https://openweathermap.org/img/wn/10d@2x.png'
//@2x enlarges the icon 2 times the size.

function getApi() {
// normal function for fetch

var queryURL = 'http://api.openweathermap.org/data/2.5/weather?q=' + savedCities[0] + '&appid=' + APIKey + '&units=imperial'; // should work inside fetch request
